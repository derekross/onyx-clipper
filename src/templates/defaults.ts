...
{{prompt:"Extract the ingredients list from this recipe as a markdown checklist with - [ ] format"}}
...
{{content}}`,
    ...
    context: 'This is a recipe page. Focus on extracting ingredients and cooking instructions clearly.',
    isDefault: true,
  },
  {
    id: 'highlight-only',
...
[Source]({{url}})`,
  ...
  },
  {
    ...
    properties: [
      ...
      { name: 'source', value: '{{url}}', type: 'text' },
      { name: 'clipped', value: '{{date}}', type: 'date' },
      { name: 'tags', value: 'clippings, summaries', type: 'list' },
    ],
    noteContentFormat: `## Summary

{{prompt:"Summarize this article in 3-5 bullet points, focusing on the key insights and takeaways"}}

## Key Quotes

{{prompt:"Extract 2-3 of the most important or quotable passages from this article"}}
...
{{content}}`,
    context: 'Summarize this article clearly and extract the most important quotes.',
    isDefault: true,
  },
  {
    id: 'github',
